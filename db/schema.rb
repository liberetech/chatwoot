...
ActiveRecord::Schema[7.0].define(version: 2024_02_05_131044) do
  ...
  create_table "conversations", id: :serial, force: :cascade do |t|
    ...
    t.index "((additional_attributes ->> 'grouping_key'::text))", name: "index_conversations_on_additional_attributes_grouping_key"
